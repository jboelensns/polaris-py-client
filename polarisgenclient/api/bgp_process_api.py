...
class BgpProcessApi(object):
    ...
    def bgp_process_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param BgpProcessObject body: BgpProcess object
        :return: BgpProcessObject
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def bgp_process_put_with_http_info(self, device_name, as_number, **kwargs):  # noqa: E501
        ...
        all_params = ['device_name', 'as_number', 'body']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/api/v0.1/device/{device_name}/bgp/{as_number}', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
