...
class HostBgpNeighborApi(object):
    ...
    def api_v01_host_bgp_neighbor_device_device_name_application_application_delete_with_http_info(self, device_name, application, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v0.1/host/bgp/neighbor/device/{device_name}/application/{application}', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v01_host_bgp_neighbor_get_with_http_info(self, device_name, **kwargs):  # noqa: E501
        ...
        all_params = ['device_name', 'application']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        return self.api_client.call_api(
            '/api/v0.1/host/bgp/neighbor', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def api_v01_host_bgp_neighbor_post(self, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param HostBgpNeighborObject body: Host BGP Neighbor object.
        :return: HostBgpNeighborObject
                 If the method is called asynchronously,
                 returns the request thread.
        """
