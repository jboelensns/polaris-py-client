...
class IpamProfileApi(object):
    ...
    def ipam_pool_get(self, name, **kwargs):  # noqa: E501
        """IpamPoolRoute.get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ipam_pool_get(name, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.ipam_pool_get_with_http_info(name, **kwargs)  # noqa: E501
        else:
            (data) = self.ipam_pool_get_with_http_info(name, **kwargs)  # noqa: E501
            return data

    def ipam_pool_get_with_http_info(self, name, **kwargs):  # noqa: E501
        """IpamPoolRoute.get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.ipam_pool_get_with_http_info(name, async_req=True)
        >>> result = thread.get()
        ...
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `ipam_pool_get`")  # noqa: E501
